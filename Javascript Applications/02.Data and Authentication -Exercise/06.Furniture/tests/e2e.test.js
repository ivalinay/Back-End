...
describe("E2E tests", function () {
  ...
  describe("Authentication", () => {
    ...
    it("register makes correct API call", async () => {
      ...
      const [request] = await Promise.all([onRequest(), page.click("#register-form >> text=Register")]);
    ...
    it("login makes correct API call", async () => {
      ...
      const [request] = await Promise.all([onRequest(), page.click("#login-form >> text=Login")]);
    ...
    it("Logout makes correct API call", async () => {
      ...
      await Promise.all([onResponse(), page.click("#login-form >> text=Login")]);
  ...
  describe("CRUD", () => {
    ...
    it("create makes correct API call for logged in user", async () => {
      ...
      const [request] = await Promise.all([onRequest(), page.click("#create-form >> text=Create")]);
