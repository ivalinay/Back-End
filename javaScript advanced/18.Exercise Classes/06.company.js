class Company {
  ...
  addEmployee(name, salary, position, department) {
    ...
    this.departments[department]["average"] =
      this.departments[department]["salaries"].reduce((acc, num) => (acc += num)) / this.departments[department]["salaries"].length;
  ...
  bestDepartment() {
    ...
    let nameSorted = Object.entries(this.departments[bestDep].workers)
      .slice()
